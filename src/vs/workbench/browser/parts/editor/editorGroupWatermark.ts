...
const openPluginProject: WatermarkEntry = { text: localize('watermark.openPluginProject', "Open Plugin Project"), id: 'pcl.community.openProject' };
const newPluginProject: WatermarkEntry = { text: localize('watermark.newPluginProject', "New Plugin Project"), id: 'pcl.community.createProject' };
const openRecent: WatermarkEntry = { text: localize('watermark.openRecent', "Open Recent"), id: 'workbench.action.openRecent' };
const newUntitledFile: WatermarkEntry = { text: localize('watermark.newUntitledFile', "New File"), id: 'workbench.action.files.newUntitledFile' };
