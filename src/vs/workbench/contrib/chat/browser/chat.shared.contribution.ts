...
configurationRegistry.registerConfiguration({
	...
	properties: {
		...
		[ChatAIDisabledSettingId]: {
			type: 'boolean',
			description: nls.localize('chat.disableAIFeatures', "Disable and hide built-in AI features (chat, agents, inline suggestions). Community Edition disables AI by default."),
			default: true,
