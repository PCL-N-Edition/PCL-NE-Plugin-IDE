...
// PCL Community keeps the chat protocol services for extension-host compatibility,
// but intentionally does not register a Chat view container or Auxiliary Bar surface.
